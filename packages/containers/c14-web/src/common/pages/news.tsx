          ...
          <div className="timeline">
            ...
            <div className="timeline-item">
              ...
              <div className="timeline-content">
                ...
                <div className="timeline-text">Substructure Search</div>
              </div>
            </div>
            ...
            <div className="timeline-item">
              ...
              <div className="timeline-content">
                ...
                <div className="timeline-text">Search by name improved and some bug fixed</div>
              </div>
            </div>
            ...
            <div className="timeline-item">
              ...
              <div className="timeline-content">
                ...
                <div className="timeline-text">Crystal Structure Viewer added</div>
              </div>
            </div>
            ...
            <div className="timeline-item">
              ...
              <div className="timeline-content">
                ...
                <div className="timeline-text">
                  Basic optimization of the project was performed (search by formula, author or unit
                  cell).
                </div>
              </div>
            </div>
