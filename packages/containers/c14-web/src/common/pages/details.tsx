        ...
        <div className="c-details-page__pub_item">
          {structure.doi ? (
            <a
              ...
              className="btn btn-primary input-inline c-details-page__doi_link"
            >
              Article
            </a>
          ) : null}
