...
import { SearchState } from '../../store/slices/search-by-author-page.slice.js';
import { type Validator, useValidationError } from './common/index.js';
...
const renderItemValue = (item: SuggestedAuthor, search: string): React.ReactNode => {
...
const autoCompleteSource = (
  ...
  fetch('/api/v1/autocomplete/author?name=' + encodeURIComponent(value), {
    ...
    .then((res) => res.json())
    .then((data: { data?: { full: string; count: number }[] }) => {
