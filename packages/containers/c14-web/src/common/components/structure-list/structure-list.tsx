        ...
        return (
          <div className="c-structure-list-item" key={item.id}>
            ...
            <a
              ...
              target="_blank"
              href={`/cif/${item.id}`}
              className="c-structure-list-item__cif_download"
              download
            >
              <DownloadIcon />
            </a>
            ...
            <p className="c-structure-list-item__journal">
              {item.articleHtml ? (
                <span dangerouslySetInnerHTML={{ __html: item.articleHtml }} />
              ) : (
                ''
              )}
            </p>
            <p className="c-structure-list-item__unit-cell">
              <b>a</b>={item.a}Å&nbsp;&nbsp;&nbsp;<b>b</b>={item.b}Å&nbsp;&nbsp;&nbsp;<b>c</b>=
              {item.c}Å
            </p>
            <p className="c-structure-list-item__unit-cell">
              <b>α</b>={item.alpha}°&nbsp;&nbsp;&nbsp;<b>β</b>={item.beta}°&nbsp;&nbsp;&nbsp;
              <b>γ</b>={item.gamma}°
            </p>
          </div>
        );
